    ...
    match value:
        case "var_1_1":
            text = md.text(
                ...
                md.text(md.bold("Заказ от 500 евро"),
                        ...
                        "оформления 3500 тенге (500 рублей). Таможенный лимит для беспошлинного ввоза сейчас "
                        "1000 евро."),
                md.text(" "),
                ...
                md.text(" "),
                md.text(
                    "Наполняете корзину товарами и даете доступ, мы копируем в свой аккаунт. Если корзина небольшая "
                    "можно "
        ...
        case "var_1_2":
            text = md.text(
                ...
                md.text("Риски для покупателя здесь в основном связаны с казахской таможней, но у нас есть"
                        " договор с проверенным таможенным брокером и риски минимизированные."),
                md.text(" "),
                md.text(
                    "*Доставка СДЕК. Важно!*",
                    "Если у вас есть малейшие сомнения в целостности послки или она помята,"
                    " вскрывать нужно в пункте СДЭК. Посылка застрахована на полную сумму."
        ...
        case "var_2_1":
            text = md.text(
                ...
                md.text("Из плюсов на этом сайте можно купить шимано, гармины и спеш. Если вы не сможете их "
                        ...
                        " сроки отправки и часто нет товаров заявленных как ",
                        md.italic("на складе. "),
                        "Также посылки тут чаще теряются при транспортировке, чем у немцев."
                        ),
                md.text(" "),
                md.text("Если сумма покупки до 300 евро это относительно без рисковая схема, для больших сумм "
                ...
                md.text("При отсутствии товара и после возмещения полученного от магазина, я верну эту сумму вам "
                        ...
                        "Для возврата необходимо написать мне о возврате через неделю после отправки заказа, "
                        "c указанием "
                ...
                md.text("4. Защита Покупателя и страховка Route. Все заказы застрахованы страховкой перевозчиков,"
                        "в случае, если вы не получите свой заказ, у вас есь гарантия возврата денег. Есть "
                        "дополнительный "
                ...
                md.text("5. Оплата на этом сайте при поставке в Россию только с помощью paypal, сколько это продлится "
                        ...
                        "примеру, будут тоже заблокированы."),
                md.text(" "),
        ...
        case "var_2_2":
            text = md.text(
                ...
                md.text(
                    "Товары стоимостью выше 300 евро, если это косметика, одежда, обувь, аксессуары, спортивные "
                    "товары, "
                    "ювелирные изделия и другие повседневные товары;"),
                md.text("Бытовая техника свыше 750 евро за единицу товара;"),
                md.text("Фото и видеокамеры, а также фотовспышки стоимостью выше 1000 евро"),
        ...
        case "var_3_1":
            text = md.text(
                ...
                md.text("В этой схеме мы только оплачиваем товар и взаимодействуем с вами на этапе покупки в "
                        "выбранном интернет-магазине, все остальные операции осуществляет бандеролька или другой"
                ...
                md.text("Да конечно вы можете всё сделать самостоятельно через бандерольку без нас. Но выкуп товара "
                        "у нас дешевле. Кроме того многие вопросы связанные с заказами (замена товара, возвраты и "
                        "т.д.) мы решаем более оперативно."),
                sep="\n")
        case "var_3_2":
            text = md.text(
                md.text("*Список товаров запрещённых к ввозу в Россию*"),
                ...
                md.text(
                    "Товары стоимостью выше 300 евро, если это косметика, одежда, обувь, аксессуары, спортивные "
                    "товары, ювелирные изделия и другие повседневные товары;"),
